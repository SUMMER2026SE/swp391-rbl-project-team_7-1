...
export default function VerifyEmail() {
  ...
  const handleResend = async () => {
    ...
    try {
      ...
      alert('Một mã xác thực OTP mới đã được gửi thành công về email của bạn!');
    } catch (err) {
  ...
  const handleVerify = async (e) => {
    ...
    try {
      ...
      alert('Tài khoản đã được xác thực thành công! Bạn có thể đăng nhập ngay bây giờ.');
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-margin-mobile md:p-lg antialiased text-on-surface bg-[#F8FAFC] w-full">
