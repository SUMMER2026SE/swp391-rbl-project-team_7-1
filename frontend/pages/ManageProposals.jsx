...
<h1 className="text-2xl font-bold tracking-tight text-slate-800">
                            Manage Proposals for: <span className="font-normal text-slate-600">Enterprise Dashboard Redesign</span>
</h1>
</div>
...
<span className="text-sm font-medium text-outline">(124 jobs)</span>
</div>
</div>
</div>
...
<div className="flex gap-2">
<span className="px-3 py-1 bg-tertiary-container/10 text-xs font-bold uppercase tracking-wider rounded-full border border-tertiary-container/30 bg-slate-100 text-[#0F766E]">Shortlisted</span>
</div>
<div className="text-right">
<div className="text-lg font-bold font-bold text-[#0F766E]">$4,500</div>
<div className="text-sm font-medium text-outline">in 3 weeks</div>
</div>
</div>
...
<span className="text-sm font-medium text-outline">(89 jobs)</span>
</div>
</div>
</div>
<div className="flex flex-wrap gap-2">
...
<div className="flex justify-between items-start">
<div className="flex gap-2">
<span className="px-3 py-1 bg-surface-container text-xs font-bold uppercase tracking-wider rounded-full border border-outline-variant/50 text-slate-600 bg-slate-100">Pending Review</span>
</div>
<div className="text-right">
<div className="text-lg font-bold font-bold text-[#0F766E]">$3,800</div>
<div className="text-sm font-medium text-outline">in 4 weeks</div>
</div>
</div>
<div className="bg-surface-container-low p-4 rounded-2xl border border-outline-variant/50">
<p className="text-sm font-medium line-clamp-3 text-slate-600">
