          ...
          <div className="lg:col-span-8 flex flex-col gap-8">
            ...
            <div className="bg-white rounded-2xl border border-slate-100 p-8 shadow-sm hover:shadow-md transition-all duration-300">
              ...
              <div className="text-base space-y-5 text-slate-600 leading-relaxed">
                <p>Chúng tôi tìm kiếm nhà thiết kế UI/UX giàu kinh nghiệm để cải tạo toàn bộ bảng điều khiển nội bộ doanh nghiệp. Hệ thống hiện tại đã lỗi thời và nhóm cần giao diện hiện đại, hiệu quả cao để quản lý vận hành hàng ngày.</p>
